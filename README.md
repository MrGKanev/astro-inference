...
A plain-text markdown version of any page on your site. Strips navigation, footer, scripts, and styles — leaving only the semantic content.
...
3. `/[...slug]/machine.txt` fetches the original page HTML, strips non-semantic elements (navigation, footer, scripts, styles), and converts the remainder to clean markdown.
